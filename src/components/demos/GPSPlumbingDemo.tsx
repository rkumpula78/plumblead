...
const CLIENT_COLOR = '#1A5C2A'; // GPS green
...
const GPSPlumbingDemo: React.FC = () => {
      ...
      <div style={{ ...s, minHeight: '100vh', background: '#f8fafc', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
        <div style={{ maxWidth: 480, width: '100%', background: '#fff', borderRadius: 16, padding: 40, boxShadow: '0 4px 24px rgba(0,0,0,0.08)', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: 15, color: '#64748b', lineHeight: 1.6, marginBottom: 24 }}>
            Thanks {name.split(' ')[0]}! Someone from <strong>GPS Plumbing</strong> will reach out within 60 seconds.
          </p>
          ...
          {urgency === 'emergency' && (
            <div style={{ background: '#fee2e2', border: '1px solid #fecaca', borderRadius: 10, padding: '12px 16px', marginBottom: 16, fontSize: 14, color: '#dc2626', fontWeight: 600 }}>
              🚨 Emergency? Call now: <a href={`tel:${CLIENT_PHONE.replace(/\D/g,'')}`} style={{ color: '#dc2626' }}>{CLIENT_PHONE}</a> — GPS Plumbing is available 24/7
            </div>
          )}
  ...
  return (
    <div style={{ ...s, minHeight: '100vh', background: '#f8fafc' }}>
      ...
      {/* Hero */}
      <div style={{ background: `linear-gradient(135deg, ${CLIENT_COLOR} 0%, #0a2e12 100%)`, color: '#fff', padding: '48px 24px', textAlign: 'center' }}>
        ...
        <h1 style={{ fontSize: 36, fontWeight: 900, marginBottom: 12, lineHeight: 1.1 }}>Local, Family-Owned<br />Plumbing — Instant Quote</h1>
        <p style={{ fontSize: 16, color: 'rgba(255,255,255,0.8)', maxWidth: 480, margin: '0 auto', lineHeight: 1.5 }}>Serving Snohomish &amp; King counties since 2020. Licensed journeymen plumbers with 100% satisfaction guarantee.</p>
      ...
      <div style={{ maxWidth: 680, margin: '0 auto', padding: '32px 24px' }}>
        ...
        {step === 1 && (
          <div style={{ opacity: mounted ? 1 : 0, transition: 'opacity 0.3s' }}>
            ...
            <p style={{ fontSize: 14, color: '#64748b', marginBottom: 24 }}>Select your service and get an instant estimate from our licensed journeymen plumbers.</p>
        ...
        {step === 2 && (
          <div>
            ...
            <div style={{ background: '#fff', borderRadius: 12, padding: 24, boxShadow: '0 1px 4px rgba(0,0,0,0.06)', marginBottom: 20 }}>
              ...
              <textarea value={details} onChange={e => setDetails(e.target.value)} placeholder="e.g. Water heater not producing hot water, unit is 8 years old. House in Monroe, WA." rows={4}
            ...
            <div style={{ background: '#fff', borderRadius: 12, padding: 24, boxShadow: '0 1px 4px rgba(0,0,0,0.06)' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                ...
                <div style={{ display: 'flex', gap: 8, alignItems: 'flex-start', padding: '12px', background: '#f8fafc', borderRadius: 8 }}>
                  ...
                  <label htmlFor="consent" style={{ fontSize: 12, color: '#64748b', lineHeight: 1.5, cursor: 'pointer' }}>I agree to receive SMS updates about my service request from GPS Plumbing Inc. Reply STOP to opt out.</label>
                </div>
      ...
      <div style={{ background: CLIENT_COLOR, color: '#fff', padding: '32px 24px', textAlign: 'center', marginTop: 40 }}>
        ...
        <div style={{ fontSize: 13, color: 'rgba(255,255,255,0.7)', marginBottom: 12 }}>26016 132nd St SE, Monroe, WA 98272 · Snohomish & King Counties</div>
